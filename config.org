...
;; Google Drive integration for exporting and importing files
...
(after! org-capture
  ...
  (defvar +org-capture-recipies  "~/org/personal/household/cookbook.org")
...
(setq org-roam-directory "~/Box/org/roam/")
#+end_src
...
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p "~/Box/org/roam/") "no" "packages.el")
