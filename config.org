...
(setq org-gcal-client-id (getenv "ORG_GCAL_CLIENT_ID")
      ...
      org-gcal-fetch-file-alist `((,(print (getenv "ORG_GCAL_CAL_ID_1")) . "~/orgfiles/org/cal-gmail.org")
                                  (,(print (getenv "ORG_GCAL_CAL_ID_2")) . "~/orgfiles/org/cal-family.org")))
#+end_src
...
(after! org-capture
  ...
  (defvar +org-capture-recipies  "~/orgfiles/org/personal/household/cookbook.org")
